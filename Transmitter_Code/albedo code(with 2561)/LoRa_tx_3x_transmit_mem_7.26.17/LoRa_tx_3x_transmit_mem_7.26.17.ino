...
Adafruit_TSL2561_Unified tsl1 = Adafruit_TSL2561_Unified(TSL2561_ADDR_FLOAT, 25611); // can pass in a number for the sensor identifier (for your use later)
Adafruit_TSL2561_Unified tsl2 = Adafruit_TSL2561_Unified(TSL2561_ADDR_GROUND, 25611);
...
void newadvancedRead(Adafruit_TSL2561_Unified tsl, uint16_t* full_ar, uint16_t* ir_ar) {
	for (int i = 0; i < 5; i++) {
	}
}
